...
load([out_dir, '/ENC_Memory_Performance.mat'])
...
%% Contrasting episodic memory performance against zero for the ENC group
disp('Testing Episodic memory performance against zero for the ENC group...')
ENC_mem = mean(mem_perf_sorted,1,'omitmissing')';
zrs = zeros(15,1);
