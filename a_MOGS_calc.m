...
for grp=1:length(seq_score(1,1,:)) 
    ...
    for subject = 1:size(subs,2)
        ...
        if grp==2
            ...
            mem_perf_sorted(:,subject) = mem_perf(sort_idx, 2);
        end
    ...
    clearvars -except grp microoffline microonline ITI root_dir mem_perf mem_perf_sorted home_dir out_dir scripts_dir seq_score seq_ccount MOGS_data
...
save('ENC_Memory_Performance.mat',"mem_perf_sorted","-v7.3")
