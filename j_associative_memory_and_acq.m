...
%% Load in data
load([home_dir '\ENC_SEM_Memory_Performance.mat'])
load([home_dir '\a_data.mat'])
load([home_dir '\b_data.mat'])
load([home_dir '\c_data.mat'])
load([home_dir '\diff_perf.mat'])
...
% Save figure
savefig([fig_dir, '\Figure_4A.fig']);
exportgraphics(gca, [fig_dir, '\Figure_4A.tiff'], 'Resolution', 300)
...
% Save figure
savefig([fig_dir, '\Figure_4B.fig']);
exportgraphics(gca, [fig_dir, '\Figure_4B.tiff'], 'Resolution', 300)
...
% Save figure
savefig([fig_dir, '\Figure_4C.fig']);
exportgraphics(gca, [fig_dir, '\Figure_4C.tiff'], 'Resolution', 300)
...
% Save figure
savefig([fig_dir, '\Figure_4D.fig']);
exportgraphics(gca, [fig_dir, '\Figure_4D.tiff'], 'Resolution', 300)
