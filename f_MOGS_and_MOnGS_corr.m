...
%
% Requirements: Access to files generated from "a_MOGS_MOnGS_calc.m" and "b_MOGS_MOnGS_group_analysis.m.
%
% indicate where your data output from a_MOGS_MOnGS_calc.m went

home_dir =  'G:\My Drive\DataScience\UT_Austin\MOGS\processed_data'; %root_dir

% Tests: 
% 1) Basic correlation between MOGS and MOnGS for first 11 trials
%
% Plots:
% 1) None
...
%% Load data
load([home_dir,'/Microoffline_data.mat'])
load([home_dir,'/Microonline_data.mat'])
