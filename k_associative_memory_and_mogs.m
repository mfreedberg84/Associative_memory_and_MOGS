...
%% Load data
load([home_dir,'/Mogs_by_part.mat'])
load([home_dir,'/Mongs_by_part.mat'])
load([home_dir,'/ENC_SEM_Memory_Performance'])
...
% Save figure
savefig([fig_dir, '\Figure_4E.fig']);
exportgraphics(gca, [fig_dir, '\Figure_4E.tiff'], 'Resolution', 300)
