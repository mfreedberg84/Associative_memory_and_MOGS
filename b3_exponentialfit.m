function [bestparams, rr, minls, exitflag] = b3_exponentialfit(xdata,ydata)
...
[params, fval, exitflag] = fmincon(@(x)b4_exponential_ls(x,xdata,ydata),startparams,[],[],[],[],[lb_a lb_b lb_r],[ub_a ub_b ub_r],[],options);
...
predy = b5_exponential(xdata, bestparams(1), bestparams(2), bestparams(3));
