clear; clc;
%% Analysis 2: Determine whether associative memory performance for the ENC 
%
% Requirements: Access to "_processed_data" files generated from "b1_acquisition_retention.m".
%
% The paths to these folders must be specified here:
home_dir = 'G:\My Drive\DataScience\UT_Austin\MOGS'; %root_dir
load_dir = '';
out_dir = '';
